...
Crear un directorio para contener el proyecto llamado `node-rest-proy`.
...
```sh
docker exec -it node-rest-proy-web-service-1 sh
```

> **NOTA**
> El nombre del contenedor (`node-rest-proy-web-service-1`) puede cambiar dependiendo
